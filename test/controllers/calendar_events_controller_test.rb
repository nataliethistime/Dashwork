...
class CalendarEventsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calendar_event" do
    assert_difference('CalendarEvent.count') do
      post calendar_events_url, params: { calendar_event: { description: @calendar_event.description, end_at: @calendar_event.end_at, name: @calendar_event.name, start_at: @calendar_event.start_at } }
    end
  ...
  test "should update calendar_event" do
    patch calendar_event_url(@calendar_event), params: { calendar_event: { description: @calendar_event.description, end_at: @calendar_event.end_at, name: @calendar_event.name, start_at: @calendar_event.start_at } }
